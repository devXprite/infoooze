    ...
    urlList.forEach(url => {
        try {
            ...
            request({
                ...
                if (error) {
                    console.log('\t\t['.cyan + chalk.redBright('---') + '] '.cyan + url.brightRed);
                } else {
                    if (response.statusCode == 200) {
                        console.log('\t\t['.cyan + chalk.green(response.statusCode) + '] '.cyan + url.green);
                    } else {
                        console.log('\t\t['.cyan + chalk.redBright(response.statusCode) + '] '.cyan + url.brightRed);
